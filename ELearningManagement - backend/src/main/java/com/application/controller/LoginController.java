...
public class LoginController
{
    ...
    {
    	return "Welcome to E-Paathashala !!!";
    }
	...
	public User loginUser(@RequestBody User user) throws Exception
	{
		...
		if(userObj == null)
		{
			throw new Exception("User does not exist.Please enter valid credentials or create new account");
		}
		return userObj;
	}
	...
	public Professor loginDoctor(@RequestBody Professor professor) throws Exception
	{
		...
		{
			throw new Exception("Account does not exist. Please enter valid credentials.");
		}
		return professorObj;
	}
}
